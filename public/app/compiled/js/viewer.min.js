...
else if("object"===s){"production"!==c.env.NODE_ENV?k(!a||1!==a.nodeType,"traverseAllChildren(...): Encountered an invalid child; DOM elements are not valid children of React components."):k(!a||1!==a.nodeType);for(var v in a)a.hasOwnProperty(v)&&(i+=p(a[v],b+(b?m:l)+g(v)+m+e(a[v],0),d+i,f,h))}else if("string"===s){var w=j(a);f(h,w,u,d),i+=1}else if("number"===s){var x=j(""+a);f(h,x,u,d),i+=1}}return i};b.exports=h}).call(this,a("_process"))},{"./ReactInstanceHandles":60,"./ReactTextComponent":76,"./invariant":121,_process:1}],144:[function(a,b){(function(c){"use strict";var d=a("./emptyFunction"),e=d;"production"!==c.env.NODE_ENV&&(e=function(a,b){var c=Array.prototype.slice.call(arguments,2);if(void 0===b)throw new Error("`warning(condition, format, ...args)` requires a warning message argument");if(!a){var d=0;console.warn("Warning: "+b.replace(/%s/g,function(){return c[d++]}))}}),b.exports=e}).call(this,a("_process"))},{"./emptyFunction":103,_process:1}],145:[function(a,b){b.exports=a("./lib/React")},{"./lib/React":28}],146:[function(a,b){var c=a("react"),d=c.createClass({displayName:"ViewToolbar",render:function(){return c.DOM.div({id:"viewToolbar"},c.DOM.div({className:"container-fluid"},c.DOM.div({className:"title"},c.DOM.a({href:"/"},c.DOM.img({src:"app/img/logo.png",className:"logo"}))),c.DOM.div({className:"row innerBody"},c.DOM.div({className:"col-xs-12"},c.DOM.p({className:"descript"},"Your share link is:"),c.DOM.div({className:"container"},c.DOM.input({id:"shortLink",value:"http://rls.li/r/"+this.props.rid}),c.DOM.a({className:"button","data-clipboard-text":"http://rls.li/r/"+this.props.rid,href:"#",id:"shortLinkLink"},"Share"))),c.DOM.div({className:"col-xs-12"},c.DOM.p({className:"descript"},"Track it with:"),c.DOM.div({className:"container"},c.DOM.input({id:"trackingLink",value:"http://riotlink.net/t/"+this.props.tid}),c.DOM.a({className:"button",href:"http://riotlink.net/t/"+this.props.tid,target:"_blank",id:"trackingLinkLink"},"Track"))))))}});b.exports=d},{react:145}],147:[function(a){function b(){{var a={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(b,c,d){a[c]=d})}return a}var c=a("react"),d=a("./global/viewToolbar.jsx"),e=io(),f=b().rid,g=b().tid,h=(b().link,b().tt);e.emit("connected",{rid:f});var i=c.createClass({displayName:"Page",getInitialState:function(){return{rid:f,tid:g}},componentDidMount:function(){$("#debugMessage").hide(),setTimeout(function(){$("#debugMessage").fadeIn()},1e3),"undefined"!=typeof h||($("#viewToolbar").hide(),$("#site").css({height:"100%"})),$("#site").attr("src",b().link),window.history.replaceState("Object","Title","r/"+b().rid);var a=new ZeroClipboard(document.getElementById("shortLinkLink"));a.on("ready",function(){a.on("aftercopy",function(){$("#shortLinkLink").html("Copied!")})})},render:function(){return c.DOM.div({className:"reactBody"},d({rid:this.state.rid,tid:this.state.tid}),c.DOM.div({id:"debugMessage"},c.DOM.h4(null,"Blank Page?"),c.DOM.p(null,"Your supplied link may not support advanced tracking, disable this by toggling off advanced tracking on our home page.",c.DOM.br(null),c.DOM.br(null),c.DOM.img({src:"http://i.gyazo.com/e0a805d870e5fd4456676cfca37bf32e.png"}))),c.DOM.iframe({border:"0",height:"100%",width:"100%",src:"null",id:"site"}))}});c.renderComponent(i(null),document.getElementById("render"))},{"./global/viewToolbar.jsx":146,react:145}]},{},[146,147]);